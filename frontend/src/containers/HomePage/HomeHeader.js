...
const mapDispatchToProps = dispatch => {
    return {
        ...
        // processLogout: () => dispatch(actions.processLogout()), // if you have a logout action
        // fetchAllUser: () => dispatch(actions.fetchAllUserStart()), // if you have a fetch all user action
        // createNewUser: (data) => dispatch(actions.createNewUser(data)), // if you have a create new user action
        // deleteUser: (userId) => dispatch(actions.deleteUser(userId)), // if you have a delete user action
        // editUser: (data) => dispatch(actions.editUser(data)), // if you have an edit user action
    };
};
